...
export default class extends Command {
	...
	async run (message, [...params]) {
		...
		if (!user.kickable) return message.reply('that member could not be kicked, please make sure that the M8 Bot role is higher than the users highest role and has permission to kick users.')
